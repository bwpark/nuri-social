...
import com.nuri.social.config.audit.AuditEventConverter;
...
public class CustomAuditEventRepository implements AuditEventRepository {
	...
	public List<AuditEvent> find(String principal, Instant after, String type) {
		Iterable<PersistentAuditEvent> persistentAuditEvents = persistenceAuditEventRepository.findByPrincipalAndAuditEventDateAfterAndAuditEventType(principal,
				after, type);
