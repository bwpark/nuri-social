...
public class EmotionService {
	...
	public List<EmotionDTO> findAll() {
		...
		return emotionRepository.findAll().stream().map(emotionMapper::toDto).collect(Collectors.toCollection(LinkedList::new));
	}
	...
	public Optional<EmotionDTO> findOne(String id) {
		...
		return emotionRepository.findById(id).map(emotionMapper::toDto);
	}
