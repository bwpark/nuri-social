...
import com.nuri.social.repository.UserRepository;
import com.nuri.social.security.SecurityUtils;
import com.nuri.social.service.MailService;
import com.nuri.social.service.UserService;
import com.nuri.social.service.dto.PasswordChangeDTO;
import com.nuri.social.service.dto.UserDTO;
import com.nuri.social.web.rest.errors.EmailAlreadyUsedException;
import com.nuri.social.web.rest.errors.InvalidPasswordException;
import com.nuri.social.web.rest.errors.LoginAlreadyUsedException;
import com.nuri.social.web.rest.vm.KeyAndPasswordVM;
import com.nuri.social.web.rest.vm.ManagedUserVM;
...
public class AccountResource {
	...
	public UserDTO getAccount() {
		return userService.getUserWithAuthorities().map(UserDTO::new).orElseThrow(() -> new AccountResourceException("User could not be found"));
	}
