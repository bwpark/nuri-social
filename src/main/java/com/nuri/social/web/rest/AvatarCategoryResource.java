...
public class AvatarCategoryResource {
     ...
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new avatarCategoryDTO, or with status {@code 400 (Bad Request)} if the avatarCategory has already an ID.
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated avatarCategoryDTO,
     * or with status {@code 400 (Bad Request)} if the avatarCategoryDTO is not valid,
     * or with status {@code 500 (Internal Server Error)} if the avatarCategoryDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    ...
    public ResponseEntity<AvatarCategoryDTO> updateAvatarCategory(@Valid @RequestBody AvatarCategoryDTO avatarCategoryDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, avatarCategoryDTO.getId()))
            .body(result);
    }
     ...
     *
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of avatarCategories in body.
     */
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the avatarCategoryDTO, or with status {@code 404 (Not Found)}.
     */
