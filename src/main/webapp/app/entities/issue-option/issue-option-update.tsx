  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="nuriSocialApp.issueOption.home.createOrEditLabel">
            <Translate contentKey="nuriSocialApp.issueOption.home.createOrEditLabel">Create or edit a IssueOption</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : issueOptionEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                >
                  <option value="ORIGINATE">{translate('nuriSocialApp.IssueOptionStatus.ORIGINATE')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup>
