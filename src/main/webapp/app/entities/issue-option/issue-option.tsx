  ...
  return (
    <div>
      <h2 id="issue-option-heading">
        <Translate contentKey="nuriSocialApp.issueOption.home.title">Issue Options</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="nuriSocialApp.issueOption.home.createLabel">Create new Issue Option</Translate>
        </Link>
      </h2>
        ...
        {issueOptionList && issueOptionList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="nuriSocialApp.issueOption.name">Name</Translate>
                </th>
                <th>
                  <Translate contentKey="nuriSocialApp.issueOption.description">Description</Translate>
                </th>
                <th>
                  <Translate contentKey="nuriSocialApp.issueOption.coin">Coin</Translate>
                </th>
                <th>
                  <Translate contentKey="nuriSocialApp.issueOption.point">Point</Translate>
                </th>
                <th>
                  <Translate contentKey="nuriSocialApp.issueOption.status">Status</Translate>
                </th>
                <th>
                  <Translate contentKey="nuriSocialApp.issueOption.created">Created</Translate>
                </th>
                <th>
                  <Translate contentKey="nuriSocialApp.issueOption.modified">Modified</Translate>
                </th>
                <th>
                  <Translate contentKey="nuriSocialApp.issueOption.issue">Issue</Translate>
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {issueOptionList.map((issueOption, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    <Translate contentKey={`nuriSocialApp.IssueOptionStatus.${issueOption.status}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="nuriSocialApp.issueOption.home.notFound">No Issue Options found</Translate>
            </div>
          )
        )}
      </div>
