  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="nuriSocialApp.dealOption.home.createOrEditLabel">
            <Translate contentKey="nuriSocialApp.dealOption.home.createOrEditLabel">Create or edit a DealOption</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : dealOptionEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                >
                  <option value="ORIGINATE">{translate('nuriSocialApp.DealOptionStatus.ORIGINATE')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup>
