  ...
  return (
    <div>
      <h2 id="deal-option-heading">
        <Translate contentKey="nuriSocialApp.dealOption.home.title">Deal Options</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="nuriSocialApp.dealOption.home.createLabel">Create new Deal Option</Translate>
        </Link>
      </h2>
        ...
        {dealOptionList && dealOptionList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="nuriSocialApp.dealOption.name">Name</Translate>
                </th>
                <th>
                  <Translate contentKey="nuriSocialApp.dealOption.status">Status</Translate>
                </th>
                <th>
                  <Translate contentKey="nuriSocialApp.dealOption.created">Created</Translate>
                </th>
                <th>
                  <Translate contentKey="nuriSocialApp.dealOption.modified">Modified</Translate>
                </th>
                <th>
                  <Translate contentKey="nuriSocialApp.dealOption.pack">Pack</Translate>
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {dealOptionList.map((dealOption, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    <Translate contentKey={`nuriSocialApp.DealOptionStatus.${dealOption.status}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="nuriSocialApp.dealOption.home.notFound">No Deal Options found</Translate>
            </div>
          )
        )}
      </div>
