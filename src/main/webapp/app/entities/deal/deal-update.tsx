  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="nuriSocialApp.deal.home.createOrEditLabel">
            <Translate contentKey="nuriSocialApp.deal.home.createOrEditLabel">Create or edit a Deal</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : dealEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                >
                  <option value="ORIGINATE">{translate('nuriSocialApp.DealStatus.ORIGINATE')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup>
