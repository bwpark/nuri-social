  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="nuriSocialApp.report.home.createOrEditLabel">
            <Translate contentKey="nuriSocialApp.report.home.createOrEditLabel">Create or edit a Report</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : reportEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="descriptionLabel" for="report-description">
                  <Translate contentKey="nuriSocialApp.report.description">Description</Translate>
                </Label>
                <AvField
              ...
              <AvGroup>
                <Label id="nameLabel" for="report-name">
                  <Translate contentKey="nuriSocialApp.report.name">Name</Translate>
                </Label>
                <AvField
                  id="report-name"
                  type="text"
              ...
              <AvGroup>
                <Label id="statusLabel" for="report-status">
                  <Translate contentKey="nuriSocialApp.report.status">Status</Translate>
                </Label>
                <AvInput
                  id="report-status"
                  type="select"
                ...
                >
                  <option value="ORIGINATE">{translate('nuriSocialApp.ReportStatus.ORIGINATE')}</option>
                  <option value="TAKEOVER">{translate('nuriSocialApp.ReportStatus.TAKEOVER')}</option>
                  <option value="COMPLETED">{translate('nuriSocialApp.ReportStatus.COMPLETED')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup>
                <Label id="createdLabel" for="report-created">
                  <Translate contentKey="nuriSocialApp.report.created">Created</Translate>
                </Label>
                <AvInput
                  id="report-created"
                  type="datetime-local"
              ...
              <AvGroup>
                <Label id="modifiedLabel" for="report-modified">
                  <Translate contentKey="nuriSocialApp.report.modified">Modified</Translate>
                </Label>
                <AvInput
                  id="report-modified"
                  type="datetime-local"
              ...
              <AvGroup>
                <Label for="report-you">
                  <Translate contentKey="nuriSocialApp.report.you">You</Translate>
                </Label>
              ...
              <AvGroup>
                <Label for="report-me">
                  <Translate contentKey="nuriSocialApp.report.me">Me</Translate>
                </Label>
