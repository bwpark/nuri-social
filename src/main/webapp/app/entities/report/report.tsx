  ...
  return (
    <div>
      <h2 id="report-heading">
        <Translate contentKey="nuriSocialApp.report.home.title">Reports</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="nuriSocialApp.report.home.createLabel">Create new Report</Translate>
        </Link>
      </h2>
        ...
        {reportList && reportList.length > 0 ? (
            ...
            <tbody>
              {reportList.map((report, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{report.name}</td>
                  <td>
                    <Translate contentKey={`nuriSocialApp.ReportStatus.${report.status}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="nuriSocialApp.report.home.notFound">No Reports found</Translate>
            </div>
          )
        )}
      </div>
