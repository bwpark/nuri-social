  ...
  return (
    <div>
      <h2 id="emotion-heading">
        <Translate contentKey="nuriSocialApp.emotion.home.title">Emotions</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="nuriSocialApp.emotion.home.createLabel">Create new Emotion</Translate>
        </Link>
      </h2>
        ...
        {emotionList && emotionList.length > 0 ? (
            ...
            <tbody>
              {emotionList.map((emotion, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    <Translate contentKey={`nuriSocialApp.EmotionStatus.${emotion.status}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="nuriSocialApp.emotion.home.notFound">No Emotions found</Translate>
            </div>
          )
        )}
      </div>
