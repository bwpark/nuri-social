  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="nuriSocialApp.emotion.home.createOrEditLabel">
            <Translate contentKey="nuriSocialApp.emotion.home.createOrEditLabel">Create or edit a Emotion</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : emotionEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="statusLabel" for="emotion-status">
                  <Translate contentKey="nuriSocialApp.emotion.status">Status</Translate>
                </Label>
                <AvInput
                  id="emotion-status"
                  type="select"
                ...
                >
                  <option value="RESPECT">{translate('nuriSocialApp.EmotionStatus.RESPECT')}</option>
                  <option value="DISS">{translate('nuriSocialApp.EmotionStatus.DISS')}</option>
                  <option value="NONE">{translate('nuriSocialApp.EmotionStatus.NONE')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup>
                <Label id="createdLabel" for="emotion-created">
                  <Translate contentKey="nuriSocialApp.emotion.created">Created</Translate>
                </Label>
                <AvInput
                  id="emotion-created"
                  type="datetime-local"
              ...
              <AvGroup>
                <Label id="modifiedLabel" for="emotion-modified">
                  <Translate contentKey="nuriSocialApp.emotion.modified">Modified</Translate>
                </Label>
                <AvInput
                  id="emotion-modified"
                  type="datetime-local"
              ...
              <AvGroup>
                <Label for="emotion-you">
                  <Translate contentKey="nuriSocialApp.emotion.you">You</Translate>
                </Label>
              ...
              <AvGroup>
                <Label for="emotion-issue">
                  <Translate contentKey="nuriSocialApp.emotion.issue">Issue</Translate>
                </Label>
              ...
              <AvGroup>
                <Label for="emotion-me">
                  <Translate contentKey="nuriSocialApp.emotion.me">Me</Translate>
                </Label>
