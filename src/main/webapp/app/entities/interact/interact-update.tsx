  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="nuriSocialApp.interact.home.createOrEditLabel">
            <Translate contentKey="nuriSocialApp.interact.home.createOrEditLabel">Create or edit a Interact</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : interactEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="respectLabel" for="interact-respect">
              ...
              <AvGroup>
                <Label id="dissLabel" for="interact-diss">
              ...
              <AvGroup>
                ...
                >
                  <option value="ORIGINATE">{translate('nuriSocialApp.InteractStatus.ORIGINATE')}</option>
                  <option value="READED">{translate('nuriSocialApp.InteractStatus.READED')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup>
