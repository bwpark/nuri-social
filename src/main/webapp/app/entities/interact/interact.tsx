  ...
  return (
    <div>
      <h2 id="interact-heading">
        <Translate contentKey="nuriSocialApp.interact.home.title">Interacts</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="nuriSocialApp.interact.home.createLabel">Create new Interact</Translate>
        </Link>
      </h2>
          ...
          {interactList && interactList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={sort('text')}>
                    <Translate contentKey="nuriSocialApp.interact.text">Text</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('coin')}>
                    <Translate contentKey="nuriSocialApp.interact.coin">Coin</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('point')}>
                    <Translate contentKey="nuriSocialApp.interact.point">Point</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('respect')}>
                    <Translate contentKey="nuriSocialApp.interact.respect">Respect</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('diss')}>
                    <Translate contentKey="nuriSocialApp.interact.diss">Diss</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('author')}>
                    <Translate contentKey="nuriSocialApp.interact.author">Author</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('status')}>
                    <Translate contentKey="nuriSocialApp.interact.status">Status</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('created')}>
                    <Translate contentKey="nuriSocialApp.interact.created">Created</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('modified')}>
                    <Translate contentKey="nuriSocialApp.interact.modified">Modified</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="nuriSocialApp.interact.you">You</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="nuriSocialApp.interact.issue">Issue</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="nuriSocialApp.interact.parent">Parent</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="nuriSocialApp.interact.me">Me</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
              <tbody>
                {interactList.map((interact, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>{interact.respect}</td>
                    <td>{interact.diss}</td>
                    <td>{interact.author}</td>
                    <td>
                      <Translate contentKey={`nuriSocialApp.InteractStatus.${interact.status}`} />
                    </td>
            ...
            !loading && (
              <div className="alert alert-warning">
                <Translate contentKey="nuriSocialApp.interact.home.notFound">No Interacts found</Translate>
              </div>
            )
          )}
        </InfiniteScroll>
