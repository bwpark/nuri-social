  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="nuriSocialApp.pack.home.createOrEditLabel">
            <Translate contentKey="nuriSocialApp.pack.home.createOrEditLabel">Create or edit a Pack</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : packEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                >
                  <option value="ORIGINATE">{translate('nuriSocialApp.PackStatus.ORIGINATE')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup>
