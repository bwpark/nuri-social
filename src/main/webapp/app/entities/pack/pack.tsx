...
export const Pack = (props: IPackProps) => {
  ...
  return (
    <div>
      <h2 id="pack-heading">
        <Translate contentKey="nuriSocialApp.pack.home.title">Packs</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="nuriSocialApp.pack.home.createLabel">Create new Pack</Translate>
        </Link>
      </h2>
        ...
        {packList && packList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="nuriSocialApp.pack.description">Description</Translate>
                </th>
                <th>
                  <Translate contentKey="nuriSocialApp.pack.coin">Coin</Translate>
                </th>
                <th>
                  <Translate contentKey="nuriSocialApp.pack.point">Point</Translate>
                </th>
                <th>
                  <Translate contentKey="nuriSocialApp.pack.shipTo">Ship To</Translate>
                </th>
                <th>
                  <Translate contentKey="nuriSocialApp.pack.status">Status</Translate>
                </th>
                <th>
                  <Translate contentKey="nuriSocialApp.pack.created">Created</Translate>
                </th>
                <th>
                  <Translate contentKey="nuriSocialApp.pack.modified">Modified</Translate>
                </th>
                <th>
                  <Translate contentKey="nuriSocialApp.pack.me">Me</Translate>
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {packList.map((pack, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{pack.shipTo}</td>
                  <td>
                    <Translate contentKey={`nuriSocialApp.PackStatus.${pack.status}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="nuriSocialApp.pack.home.notFound">No Packs found</Translate>
            </div>
          )
        )}
      </div>
