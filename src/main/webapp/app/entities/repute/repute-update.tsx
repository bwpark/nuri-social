  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="nuriSocialApp.repute.home.createOrEditLabel">
            <Translate contentKey="nuriSocialApp.repute.home.createOrEditLabel">Create or edit a Repute</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : reputeEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                >
                  <option value="ORIGINATE">{translate('nuriSocialApp.ReputeStatus.ORIGINATE')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup>
