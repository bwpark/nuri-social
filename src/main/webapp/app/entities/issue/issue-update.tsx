  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="nuriSocialApp.issue.home.createOrEditLabel">
            <Translate contentKey="nuriSocialApp.issue.home.createOrEditLabel">Create or edit a Issue</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : issueEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="respectLabel" for="issue-respect">
              ...
              <AvGroup>
                <Label id="dissLabel" for="issue-diss">
              ...
              <AvGroup>
                ...
                >
                  <option value="ORIGINATE">{translate('nuriSocialApp.IssueStatus.ORIGINATE')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup>
