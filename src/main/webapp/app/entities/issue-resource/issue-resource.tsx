  ...
  return (
    <div>
      <h2 id="issue-resource-heading">
        <Translate contentKey="nuriSocialApp.issueResource.home.title">Issue Resources</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="nuriSocialApp.issueResource.home.createLabel">Create new Issue Resource</Translate>
        </Link>
      </h2>
        ...
        {issueResourceList && issueResourceList.length > 0 ? (
            ...
            <tbody>
              {issueResourceList.map((issueResource, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    <Translate contentKey={`nuriSocialApp.ResourceType.${issueResource.type}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="nuriSocialApp.issueResource.home.notFound">No Issue Resources found</Translate>
            </div>
          )
        )}
      </div>
