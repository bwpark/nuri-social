  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="nuriSocialApp.issueResource.home.createOrEditLabel">
            <Translate contentKey="nuriSocialApp.issueResource.home.createOrEditLabel">Create or edit a IssueResource</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : issueResourceEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="typeLabel" for="issue-resource-type">
                  <Translate contentKey="nuriSocialApp.issueResource.type">Type</Translate>
                </Label>
                <AvInput
                ...
                >
                  <option value="LINK">{translate('nuriSocialApp.ResourceType.LINK')}</option>
                  <option value="IMAGE">{translate('nuriSocialApp.ResourceType.IMAGE')}</option>
                  <option value="VIDEO">{translate('nuriSocialApp.ResourceType.VIDEO')}</option>
                  <option value="FILE">{translate('nuriSocialApp.ResourceType.FILE')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup>
                <Label id="linkLabel" for="issue-resource-link">
                  <Translate contentKey="nuriSocialApp.issueResource.link">Link</Translate>
                </Label>
                <AvField
              ...
              <AvGroup>
                <Label id="createdLabel" for="issue-resource-created">
                  <Translate contentKey="nuriSocialApp.issueResource.created">Created</Translate>
                </Label>
                <AvInput
              ...
              <AvGroup>
                <Label for="issue-resource-issue">
                  <Translate contentKey="nuriSocialApp.issueResource.issue">Issue</Translate>
                </Label>
