...
export const IssueResourceDeleteDialog = (props: IIssueResourceDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="nuriSocialApp.issueResource.delete.question">
        <Translate contentKey="nuriSocialApp.issueResource.delete.question" interpolate={{ id: issueResourceEntity.id }}>
