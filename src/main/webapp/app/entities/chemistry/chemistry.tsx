  ...
  return (
    <div>
      <h2 id="chemistry-heading">
        <Translate contentKey="nuriSocialApp.chemistry.home.title">Chemistries</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="nuriSocialApp.chemistry.home.createLabel">Create new Chemistry</Translate>
        </Link>
      </h2>
        ...
        {chemistryList && chemistryList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="nuriSocialApp.chemistry.yourName">Your Name</Translate>
                </th>
                <th>
                  <Translate contentKey="nuriSocialApp.chemistry.toYou">To You</Translate>
                </th>
                <th>
                  <Translate contentKey="nuriSocialApp.chemistry.toMe">To Me</Translate>
                </th>
                <th>
                  <Translate contentKey="nuriSocialApp.chemistry.created">Created</Translate>
                </th>
                <th>
                  <Translate contentKey="nuriSocialApp.chemistry.you">You</Translate>
                </th>
                <th>
                  <Translate contentKey="nuriSocialApp.chemistry.me">Me</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="nuriSocialApp.chemistry.home.notFound">No Chemistries found</Translate>
            </div>
          )
        )}
      </div>
