  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="nuriSocialApp.chemistry.home.createOrEditLabel">
            <Translate contentKey="nuriSocialApp.chemistry.home.createOrEditLabel">Create or edit a Chemistry</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
