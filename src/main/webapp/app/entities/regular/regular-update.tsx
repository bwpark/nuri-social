  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="nuriSocialApp.regular.home.createOrEditLabel">
            <Translate contentKey="nuriSocialApp.regular.home.createOrEditLabel">Create or edit a Regular</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : regularEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                >
                  <option value="ORIGINATE">{translate('nuriSocialApp.RegularStatus.ORIGINATE')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup>
