  ...
  return (
    <div>
      <h2 id="regular-heading">
        <Translate contentKey="nuriSocialApp.regular.home.title">Regulars</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="nuriSocialApp.regular.home.createLabel">Create new Regular</Translate>
        </Link>
      </h2>
        ...
        {regularList && regularList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="nuriSocialApp.regular.name">Name</Translate>
                </th>
                <th>
                  <Translate contentKey="nuriSocialApp.regular.status">Status</Translate>
                </th>
                <th>
                  <Translate contentKey="nuriSocialApp.regular.created">Created</Translate>
                </th>
                <th>
                  <Translate contentKey="nuriSocialApp.regular.modified">Modified</Translate>
                </th>
                <th>
                  <Translate contentKey="nuriSocialApp.regular.you">You</Translate>
                </th>
                <th>
                  <Translate contentKey="nuriSocialApp.regular.me">Me</Translate>
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {regularList.map((regular, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{regular.name}</td>
                  <td>
                    <Translate contentKey={`nuriSocialApp.RegularStatus.${regular.status}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="nuriSocialApp.regular.home.notFound">No Regulars found</Translate>
            </div>
          )
        )}
      </div>
