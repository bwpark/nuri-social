...
public class AvatarResourceIT {
    ...
    public void createAvatar() throws Exception {
        ...
        assertThat(testAvatar.getRespect()).isEqualTo(DEFAULT_RESPECT);
        assertThat(testAvatar.getDiss()).isEqualTo(DEFAULT_DISS);
    ...
    public void updateAvatar() throws Exception {
        ...
        assertThat(testAvatar.getRespect()).isEqualTo(UPDATED_RESPECT);
        assertThat(testAvatar.getDiss()).isEqualTo(UPDATED_DISS);
